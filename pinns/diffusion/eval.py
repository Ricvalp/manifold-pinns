...
from pinns.diffusion.get_dataset import get_dataset
from pinns.diffusion.utils import get_last_checkpoint_dir
...
def evaluate(config: ml_collections.ConfigDict):
    """Evaluate a trained diffusion PINN checkpoint."""
