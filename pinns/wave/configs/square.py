...
def get_config():
    ...
    config.autoencoder_checkpoint.checkpoint_path = "universal_autoencoder/experiments/square/checkpoints/w58cgz50"
    config.autoencoder_checkpoint.step = 440000
    ...
    arch.fourier_emb = ml_collections.ConfigDict({"embed_scale": 2, "embed_dim": 512})
    ...
    weighting.init_weights = ml_collections.ConfigDict(
        {"ics": 10.0, "res": 1.0, "ics_derivative": 1.0}
    )
    ...
    profiler.log_dir = "pinns/wave/square/profiler"

    # Saving
    config.saving = saving = ml_collections.ConfigDict()
    saving.checkpoint_dir = (
        "pinns/wave/square/checkpoints"
    )
    ...
    eval.checkpoint_dir = "pinns/wave/square/checkpoints/"
    eval.step = 9999
